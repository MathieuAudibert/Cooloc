...
def supprimer_utilisateurs(data, token):
    con.connexion()
    ...
    log = {'date': datetime.now(), 'action': 'suppression utilisateur', 'id_utilisateur': id_utilisateur, 'id_utilisateur_supprime': data['id_utilisateur_supprime']}
